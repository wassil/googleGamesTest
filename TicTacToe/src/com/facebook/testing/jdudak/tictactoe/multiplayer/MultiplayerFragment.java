...
public class MultiplayerFragment extends Fragment {
	            ...
	            ResultCallback<TurnBasedMultiplayer.InitiateMatchResult> cb = new ResultCallback<TurnBasedMultiplayer.InitiateMatchResult>() {
	                ...
	                public void onResult(TurnBasedMultiplayer.InitiateMatchResult result) {
	                	if (result.getStatus().getStatusCode() != GamesStatusCodes.STATUS_OK) {
	                        Log.e(Const.TAG, Integer.toString(result.getStatus().getStatusCode()));
	                        return;
	                    }
	                    ...
	                    if (match.getData() != null) { //not my turn
	                    	...
	                    	startTurnBasedMatchActivity(match);
	                    }	
	                }
	            };
	...
	private void startTurnBasedMatchActivity(TurnBasedMatch match) {
		Intent intent = new Intent(this.getActivity(), TurnBasedActivity.class);
