...
public class GiftsFragment extends Fragment {
	 ...
	 */
	public static void handleRequests(ArrayList<GameRequest> requests, final BaseGameActivity activity) {
	    ...
	    switch (requestCode) {
	        case Const.REQUEST_SHOW_GIFT_INBOX:
	            if (resultCode == Activity.RESULT_OK && data != null) {          
	                handleRequests(Games.Requests.getGameRequestsFromInboxResponse(data), (BaseGameActivity)getActivity());
	            } else {
